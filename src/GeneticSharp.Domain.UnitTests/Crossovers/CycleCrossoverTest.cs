...
namespace GeneticSharp.Domain.UnitTests.Crossovers
{
    ...
    public class CycleCrossoverTest
    {
        ...
        public void Cross_ParentsWith10Genes_Cross()
        {
            ...
            ClassicAssert.AreEqual(8, actual[0].GetGene(0).Value);
            ClassicAssert.AreEqual(1, actual[0].GetGene(1).Value);
            ClassicAssert.AreEqual(2, actual[0].GetGene(2).Value);
            ClassicAssert.AreEqual(3, actual[0].GetGene(3).Value);
            ClassicAssert.AreEqual(4, actual[0].GetGene(4).Value);
            ClassicAssert.AreEqual(5, actual[0].GetGene(5).Value);
            ClassicAssert.AreEqual(6, actual[0].GetGene(6).Value);
            ClassicAssert.AreEqual(7, actual[0].GetGene(7).Value);
            ClassicAssert.AreEqual(9, actual[0].GetGene(8).Value);
            ClassicAssert.AreEqual(0, actual[0].GetGene(9).Value);

            ClassicAssert.AreEqual(0, actual[1].GetGene(0).Value);
            ClassicAssert.AreEqual(4, actual[1].GetGene(1).Value);
            ClassicAssert.AreEqual(7, actual[1].GetGene(2).Value);
            ClassicAssert.AreEqual(3, actual[1].GetGene(3).Value);
            ClassicAssert.AreEqual(6, actual[1].GetGene(4).Value);
            ClassicAssert.AreEqual(2, actual[1].GetGene(5).Value);
            ClassicAssert.AreEqual(5, actual[1].GetGene(6).Value);
            ClassicAssert.AreEqual(1, actual[1].GetGene(7).Value);
            ClassicAssert.AreEqual(8, actual[1].GetGene(8).Value);
            ClassicAssert.AreEqual(9, actual[1].GetGene(9).Value);
        }
        ...
        public void Cross_ParentsWith5OneCycleGenes_Cross()
        {
            ...
            ClassicAssert.AreEqual(2, actual.Count);
            ClassicAssert.AreEqual(5, actual[0].Length);
            ClassicAssert.AreEqual(5, actual[1].Length);

            ClassicAssert.AreEqual(5, actual[0].GetGenes().Distinct().Count());
            ClassicAssert.AreEqual(5, actual[1].GetGenes().Distinct().Count());
            ...
            ClassicAssert.AreEqual(4, actual[1].GetGene(0).Value);
            ClassicAssert.AreEqual(3, actual[1].GetGene(1).Value);
            ClassicAssert.AreEqual(6, actual[1].GetGene(2).Value);
            ClassicAssert.AreEqual(7, actual[1].GetGene(3).Value);
            ClassicAssert.AreEqual(8, actual[1].GetGene(4).Value);
        }
        ...
        public void Cross_ParentsWith5ThreeCyclesGenes_Cross()
        {
            ...
            ClassicAssert.AreEqual(8, actual[0].GetGene(0).Value);
            ClassicAssert.AreEqual(4, actual[0].GetGene(1).Value);
            ClassicAssert.AreEqual(6, actual[0].GetGene(2).Value);
            ClassicAssert.AreEqual(7, actual[0].GetGene(3).Value);
            ClassicAssert.AreEqual(3, actual[0].GetGene(4).Value);
